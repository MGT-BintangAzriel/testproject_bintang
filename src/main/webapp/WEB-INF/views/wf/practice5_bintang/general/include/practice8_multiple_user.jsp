...
<table class="imui-form tab_header">
	...
	<tbody>
		...
		<tr>
			...
			<td>
				<div class="mt-4">
					<label> <input type="radio" id="f_psd_area_1" name="f_psd_area" value="psd"
						${f:h(savedFormData.f_psd_area_psd)}> PSD (go to #2)
					</label>
				</div>
				<div class="mt-4">
					<label> <input type="radio" id="f_psd_area_2" name="f_psd_area" value="non_psd"
						${f:h(savedFormData.f_psd_area_non_psd)}> Non-PSD (end)
					</label>
				</div>
		...
		<tr>
			...
			<td>
				<div class="mt-4">
					<label> <input type="radio" id="f_psd_process_1" name="f_psd_process" value="psd"
						${f:h(savedFormData.f_psd_process_psd)}> PSD (Pitching result attached)
					</label>
				</div>
				<div class="mt-4">
					<label> <input type="radio" id="f_psd_process_2" name="f_psd_process" value="dic"
						${f:h(savedFormData.f_psd_process_dic)}> DIC (Please describe the reason in the box below)
					</label>
				</div>
				<div class="mt-4">
	...
	<tbody>
		...
		<tr>
			...
			<td>
				...
				</label> <label> <input type="radio" id="f_dd_process_0" name="f_dd_process" value="no"
					${f:h(savedFormData.f_dd_process_no)}> No
				</label>
				<div class="error_message"></div>
			</td>
		</tr>
		...
		<tr>
			...
			<td>
				...
				</label> <label> <input type="radio" id="f_anti_bribery_0" name="f_anti_bribery" value="no"
					${f:h(savedFormData.f_anti_bribery_no)}> No
				</label>
				<div class="error_message"></div>
			</td>
		</tr>
		...
		<tr>
			...
			<td>
				...
				</label> <label> <input type="radio" id="f_audit_rights_0" name="f_audit_rights" value="no"
					${f:h(savedFormData.f_audit_rights_no)}> No
				</label>
				<div class="error_message"></div>
			</td>
		</tr>
