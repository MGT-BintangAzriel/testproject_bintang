				...
				$.ajax({
					...
					success: function (response) {
						if (response.indexOf("error") === -1) {
							window.location.href = "/imarttraining/practice5_bintang/downloadpdf/" + encodeURIComponent(response.trim()) + "?token=" + encodeURIComponent('${f:h(savedFormData.f_download_token)}');
						} else {
