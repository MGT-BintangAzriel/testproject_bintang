		...
		<imsp:fieldContain label="PSD Area or Non-PSD Area:" required="true">
			<div class="custom-readonly">
				<label for="f_psd_area_psd">
					<input type="radio" name="f_psd_area" id="f_psd_area_psd" value="psd" ${f:h(savedFormData.f_psd_area_psd)}>
					PSD (go to #2)
				</label>
				<label for="f_psd_area_non_psd">
					<input type="radio" name="f_psd_area" id="f_psd_area_non_psd" value="non_psd" ${f:h(savedFormData.f_psd_area_non_psd)}>
					Non-PSD (end)
				</label>
			...
			<imsp:fieldContain label="In PSD Area, PSD Process, or DIC Process:" required="true">
				<div class="custom-readonly">
					<label for="f_psd_process_psd">
						<input type="radio" name="f_psd_process" id="f_psd_process_psd" value="psd" ${f:h(savedFormData.f_psd_process_psd)}>
						PSD (Pitching result attached)
					</label>
					<label for="f_psd_process_dic">
						<input type="radio" name="f_psd_process" id="f_psd_process_dic" value="dic" ${f:h(savedFormData.f_psd_process_dic)}>
