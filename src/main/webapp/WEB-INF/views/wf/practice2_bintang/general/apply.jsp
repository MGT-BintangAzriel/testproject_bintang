...
<imui:head>
	...
	<script type="text/javascript">
		$(function() {
			var rules = {
				f_book_name: {required: true},
				f_price : {required: true}, 
				f_reason : {required: true},
			};
			
			var messages = {
				f_book_name: {required: "書籍名を入力してください。" },
					...
					<tbody>
						<tr>
							<th width="250"><label class="imui-required"
								style="margin-left: 20px">書籍名</label></th>
							<td><input type="text" value="${FormClassRows.getF_book_name()}"
								id="f_book_name" name="f_book_name"
							...
							<td>
								<div class="form-group">
									<textarea rows="3" cols="40" name="f_reason" id="f_reason"
										class="" style="margin-left: 5px;">${FormClassRows.getF_reason()}</textarea>
								</div>
							</td>
						</tr>
					</tbody>
