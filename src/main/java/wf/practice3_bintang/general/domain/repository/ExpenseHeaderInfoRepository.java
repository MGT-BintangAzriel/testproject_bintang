...
/**
 * 経費申請情報をDBに登録・取得するリポジトリクラス。
 *
 * @author MGT-BintangAzriel
 * @version 1.0.0
 */
public class ExpenseHeaderInfoRepository {

	// 処理対象テーブル名
	private String tableName = "wf_expense_header_info";
	 ...
	 */
	public void insertDataHeader(ExpenseHeaderInfoModel varDataHeaderData) throws Exception {
		try {
	 ...
	 */
	private ColumnValues setDataValue(ExpenseHeaderInfoModel varDataHeaderData, String Condition) {
