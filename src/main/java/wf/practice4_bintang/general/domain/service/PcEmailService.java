...
public class PcEmailService {
     ...
     * @param FormClassRows PC購入申請情報が格納されたフォーム
     * @throws Exception メール送信またはデータベース更新処理中に例外が発生した場合
     */
    public void send_email(String matterId, String mail, PcForm FormClassRows) throws Exception {
