...
public class DetailTableRepository {

    private String tableName = "wf_detail_tableinfo";
    private String selectDataAll = "SELECT * FROM wf_detail_tableinfo";
    private String selectDataBy_MatterId = "SELECT * FROM wf_detail_tableinfo where system_matter_id = ?";
    ...
    public Collection<DetailTableModel> selectDataTable(String select_value, String select_where) throws Exception {
        try {
            ...
            Collection<DetailTableModel> result = sqlManager.select(DetailTableModel.class, select_query, parameters);
            return result;
    ...
    private ColumnValues setDataValue(DetailTableModel varDataDetail, String Condition) {
        ...
        if (Condition.equals("create")) {
            ...
            try {
                ...
                System.out.println(
                        "Error parsing date table data. Date string was: '" + varDataDetail.getSend_date() + "'");
                e.printStackTrace();
            }
