...
/**
 * 書籍申請情報をDBに登録・取得するリポジトリクラス。
 *
 * @author MGT-BintangAzriel
 * @version 1.0.0
 */
public class BookHeaderInfoRepository {

	// 処理対象テーブル名
	private String tableName = "wf_book_header_info";
	 ...
	 */
	public void insertDataHeader(BookHeaderInfoModel varDataHeaderData) throws Exception {
		try {
	 ...
	 */
	private ColumnValues setDataValue(BookHeaderInfoModel varDataHeaderData, String Condition) {
