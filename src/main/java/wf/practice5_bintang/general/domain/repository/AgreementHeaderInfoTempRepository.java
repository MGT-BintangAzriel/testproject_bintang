...
public class AgreementHeaderInfoTempRepository {
	...
	public void insertHeaderInfoTemp(AgreementHeaderInfoModel model) throws Exception {
		try {
			...
			sqlManager.insert(AgreementDbConstants.TABLE_HEADER_INFO_TEMP, columnVal);
	...
	public Collection<AgreementHeaderInfoModel> selectHeaderInfoTemp(String selectValue, String selectWhere) throws Exception {
		try {
			...
			e.printStackTrace();
			throw new Exception("Error in selectHeaderInfoTemp", e);
		}
	}
	...
	public void deleteHeaderInfoTemp(String filterValue, String condition) throws Exception {
		try {
			SQLManager sqlManager = new SQLManager();
			SearchCondition search = new SearchCondition();
			search.addCondition(condition, filterValue);

			sqlManager.delete(AgreementDbConstants.TABLE_HEADER_INFO_TEMP, search);
		} catch (Exception e) {
			e.printStackTrace();
			throw new Exception("Error in deleteHeaderInfoTemp", e);
		}
	}
}
