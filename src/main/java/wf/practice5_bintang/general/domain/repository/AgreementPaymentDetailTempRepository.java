...
public class AgreementPaymentDetailTempRepository {

	public void insertPaymentDetailTemp(AgreementPaymentDetailModel model) throws Exception {
	...
	public void updatePaymentDetailTemp(AgreementPaymentDetailModel model, String filterValue, String condition) throws Exception {
		SQLManager sqlManager = new SQLManager();
	...
	public void deletePaymentDetailTemp(String filterValue, String condition) throws Exception {
		SQLManager sqlManager = new SQLManager();
		SearchCondition search = new SearchCondition();
		search.addCondition(condition, filterValue);
